...
import ar.com.koodi.sermedboundaries.SermedData.ModeloData.*;
import ar.com.koodi.sermedboundaries.SermedData.RepositorioData.IPersonaRepositorioCRUD;
...
public class PersonaRepositorioImplementacion implements IPersonaRepositorio {
    ...
    public PersonaEntity mapeoCoreData(Persona persona) {
        if (persona.getIdPersona() == null) {
            ...
            return iPersonaRepositorioCRUD.findByIdPersona(persona.getIdPersona());
        }
    }
