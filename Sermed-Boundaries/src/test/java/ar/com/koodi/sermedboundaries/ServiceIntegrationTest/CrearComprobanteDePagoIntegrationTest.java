...
public class CrearComprobanteDePagoIntegrationTest {

    private String url = "http://localhost:8080";

    @Test
    public void crearComprobante_ComprobanteNoExiste_Devuelve200() throws Exception {
        JSONObject comprobante = new JSONObject();
        comprobante.put("idComprobante", null);
        comprobante.put("numeroComprobante", "1234-567891");
        comprobante.put("afiliado", factoryAfiliado());
        comprobante.put("total", 5000.65);
        comprobante.put("fechaCreacion", LocalDate.now());
        comprobante.put("modoPago", "efet papa");
        comprobante.put("activo", true);
        comprobante.put("periodosAbonados", factoryPeriodoDepago());
    ...
    @Test
    public void crearComprobante_ComprobanteExiste_Devuelve412() throws Exception {
        JSONObject comprobante = new JSONObject();
        comprobante.put("idComprobante", null);
        comprobante.put("numeroComprobante", "1234-567891");
        comprobante.put("afiliado", factoryAfiliado());
        comprobante.put("total", 600);
        comprobante.put("fechaCreacion", LocalDate.now());
        comprobante.put("modoPago", "efet papa");
        comprobante.put("activo", true);
        comprobante.put("periodosAbonados", factoryPeriodoDepago());
    ...
    private JSONArray factoryPeriodoDepago() throws JSONException {
        JSONArray jsonArray = new JSONArray();
        JSONObject periodoPago1 = new JSONObject();
        JSONObject periodoPago2 = new JSONObject();
        JSONObject periodoPago3 = new JSONObject();
        periodoPago1.put("idPeriodo", 10);
        periodoPago1.put("mes", 10);
        periodoPago1.put("anio", 2018);
        periodoPago2.put("idPeriodo", 11);
        periodoPago2.put("mes", 11);
        periodoPago2.put("anio", 2018);
        periodoPago3.put("idPeriodo", 12);
        periodoPago3.put("mes", 12);
        periodoPago3.put("anio", 2018);
        jsonArray.put(periodoPago1);
        jsonArray.put(periodoPago2);
        jsonArray.put(periodoPago3);
        return jsonArray;
    }
